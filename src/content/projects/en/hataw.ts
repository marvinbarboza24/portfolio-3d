...
export default {
  ...
  description:
    "A Valenzuela covered court — book 3v3 or full court at Bong’s, watch the board from warmup to on-court, claim the slot on the painted green floor. Last game is ten.<br/><br/>Vue 3 + Vite + GSAP. Jersey green, yellow lines, English/Filipino. Demo court: Hataw Court, Barangay Malanday Covered Court. Live on Cloudflare Pages.",
  components: [
    { type: "media", props: { type: "image", src: img0, alt: "Hataw hero with painted green court and live slot ticker", caption: "Hero" } },
    { type: "media", props: { type: "image", src: img1, alt: "Hataw board with Warmup, On court, Sideline, Next, and Done columns", caption: "The paint" } },
    { type: "media", props: { type: "image", src: img2, alt: "Hataw booking form for team name, game, and slot", caption: "Counter" } },
