...
import { getDisplayTags } from "../../../content/projects";
...
const displayTags = computed(() => getDisplayTags(projectId, content.tags));
  ...
  <div class="project-hero grid">
    <div class="project-hero-top">
      ...
      <div class="project-hero-tags">
        <Tag v-for="tag in displayTags" :key="tag" :variant="tag" />
      </div>
    </div>
